<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Window.Resources>
        <!-- Colors & Brushes (aligned with your ColumnsInput.xaml) -->
        <SolidColorBrush x:Key="TextDark"     Color="#202020"/>
        <SolidColorBrush x:Key="BorderLight"  Color="#D0D0D0"/>

        <!-- Vertical gradient purple (same as your working window) -->
        ...
        <!-- Hover & Pressed accents (same family) -->
        ...
        <!-- ProgressBar: purple gradient foreground, light track -->
    ...
    <Grid Margin="14">
        ...
        <!-- Message -->
        <TextBlock x:Name="MsgLabel" Text="Please wait..." FontSize="14" Margin="0,0,0,8"/>
